                ...
                <q-card-section>
                    <div class="row items-center justify-between">
                        <div>
                            ...
                            <div class="text-subtitle2">Add a new lesson to "{{ section.title }}"</div>
                        </div>
                        <q-btn 
                            flat 
                            color="grey-7" 
                    ...
                    <div class="row q-col-gutter-md">
                        <div class="col-12 col-md-8">
                            ...
                            <q-card flat bordered class="q-mt-md">
                                <q-card-section>
                                    <div class="text-subtitle1 q-mb-md">Lesson Settings (Optional)</div>
                                ...
                                <q-card-section>
                                    ...
                                    <div class="section-context">
                                        ...
                                        <div class="text-caption text-grey-7 q-mt-xs">
                                            Section in "{{ section.level?.title }}"
                                        </div>
                                        <div class="text-caption text-grey-7">
                                            Course: "{{ section.level?.course?.name }}"
                                        </div>
                                        
                                        <div class="q-mt-md">
                                            <q-chip size="sm" color="orange-1" text-color="orange-8" icon="school">
                                                {{ section.lessons?.length || 0 }} Existing Lessons
                                            </q-chip>
                                        </div>
                                    </div>
                                </q-card-section>
...
const submitForm = () => {
    ...
    router.post(route('course-management.sections.lessons.store', props.section.id), lessonData, {
        onSuccess: () => {
            $q.notify({
                type: 'positive',
