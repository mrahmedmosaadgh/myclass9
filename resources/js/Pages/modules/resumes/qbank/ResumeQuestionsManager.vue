<template>
  <div class="q-pa-md">
    ...
    <q-input v-model="snackbar.visible" :color="snackbar.color">{{ snackbar.message }}</q-input>
  </div>
</template>

<script setup>
import { ref, reactive, onMounted } from 'vue';
import { useQuasar, Quasar, Notify, Dialog, Loading } from 'quasar';
import resumeApi from '@/modules/resumes/resumes_questions/resumeApi.js';
import QuestionForm from './QuestionForm.vue';
import AnswerForm from './AnswerForm.vue';
import wwapp2 from '@/Pages/modules/resumes/qbank2/Demo.vue';
// resources\js@/Pages/modules/resumes/qbank2/Demo.vue
