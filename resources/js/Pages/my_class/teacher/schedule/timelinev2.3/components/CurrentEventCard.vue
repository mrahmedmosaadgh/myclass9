            ...
            <div class="p-2 pt-4">
                ...
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="flex flex-col items-end gap-2">
                        <!-- Time Badge -->
                        <div class="px-3 flex flex-row py-1.5 bg-blue-50 rounded-lg">
                            <span class="text-lg px-2 font-semibold text-blue-300 rounded-full bg-black">{{ timeRemaining }} </span>
                            <div class="text-xs text-blue-600 px-1 font-medium"> left</div>
                        </div>


                        <span class=" w-24 fixed top-0 left-10  font-semibold text-gray-200 rounded bg-black text-center">{{ currentTimeString }}</span>
                ...
                <div class="flex items-center gap-6 mb-1">
                    <div class="flex items-center gap-2">
                       ...
                       {{ event.label }}     {{ formatTime(event.from) }} - {{ formatTime(event.to) }}
                        </span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
